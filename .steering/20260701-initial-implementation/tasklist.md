...
- [ ] T5-1 🔴🟢　ログイン → ポータル遷移
- [ ] T5-2 🔴🟢　田中でプリセット送信 → 8件・合計 ¥79,000,000・①〜⑤進行
- [ ] T5-3 🔴🟢　④が初回のみ `⏳` 停止 → コンセント承認 → 完了
- [ ] T5-4 🔴🟢　山田に切替 → 同じ質問再送 → 16件・**履歴保持**・④で止まらない
- [ ] T5-5 🔴🟢　⑤フィルタ注記のユーザー連動（田中 owner 固定 / 山田 全担当）
- [ ] T5-6 🔴🟢　`NEXT_PUBLIC_MOCK_MODE=true` でモックデータ表示
